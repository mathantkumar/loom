...
public class SyntheticIncidentLoader {
    ...
    private List<Incident> generateSyntheticIncidents() {
        ...
        list.add(createIncident(
                ...
                IncidentStatus.RESOLVED, Severity.SEV2, IssueType.INFRASTRUCTURE, now.minus(2, ChronoUnit.DAYS)));
        list.add(createIncident(
        ...
        list.add(createIncident(
                ...
                IncidentStatus.RESOLVED, Severity.SEV3, IssueType.PERFORMANCE, now.minus(10, ChronoUnit.DAYS)));
        ...
        list.add(createIncident(
                ...
                IncidentStatus.RESOLVED, Severity.SEV1, IssueType.SECURITY, now.minus(1, ChronoUnit.DAYS)));
        list.add(createIncident(
                ...
                IncidentStatus.RESOLVED, Severity.SEV3, IssueType.NETWORK, now.minus(3, ChronoUnit.DAYS)));
        ...
        list.add(createIncident(
                ...
                IncidentStatus.RESOLVED, Severity.SEV2, IssueType.DATABASE, now.minus(4, ChronoUnit.DAYS)));
        list.add(createIncident(
                ...
                IncidentStatus.RESOLVED, Severity.SEV4, IssueType.PERFORMANCE, now.minus(12, ChronoUnit.DAYS)));
